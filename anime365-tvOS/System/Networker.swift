...
class Networker {
    ...
    let domain = "smotret-anime.org"
    //let domain = "anime-365.ru"
    //let domain = "smotret-anime.online"
    ...
    private func logout() {
        Session.saveSessionData(sessionData: SessionData(sessionId: "", userId: "", sessionDataName: "", sessionDataValue: ""))
        exit(1)
    }
}
